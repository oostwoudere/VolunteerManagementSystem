 ...
 */
$config['site_title']                 = "RIMS";       // Site Title, example.com
...
$config['max_text_length']            = 500;                 // Maximum Required Length of Generic Bulk Text (not enforced by lib - Custom)
$config['max_line_length']            = 50;                  // Maximum Required Length of Single Text (setup based on db - Custom)
