...
<?php $user_id = empty($user_id) ? 0 : $user_id; ?>
<?php $centers = empty($centers) ? [] : $centers; ?>
<?php $volunteer = empty($volunteer) ? 0 : $volunteer; ?>
...
<?php $link = function ($loc, $label) {
    return "<a href='/uploads/{$loc}' target='_blank'>{$label}</a> <br><small class='text-muted'>(Re-Upload If Editing)</small>";
} ?>

<?php # Input Builder ?>
<?php function create_input($field, $placeholder, $cur, $type = 'text', $required = false) : void {
    $req = ($required) ? ' required' : '';
    if(strcmp($field, 'password') == 0 || strcmp($field, 'pass_confirm') == 0) :
?>      <input type="pass" name="<?=$field?>" id="<?=$field?>" class="form-control text-bg-dark" value=""<?=$req?> placeholder="<?=$placeholder?>"> <?php
    elseif(strcmp($field, 'drivers') == 0 || strcmp($field, 'social') == 0) :
?>      <input type="file" name="<?=$field?>" id="<?=$field?>" class="form-control text-bg-dark" value=""<?=$req?> placeholder="<?=$placeholder?>"> <?php
    else :
    $val = $cur[$field] ?? '';
?>      <input type="<?=$type?>" name="<?=$field?>" id="<?=$field?>" class="form-control text-bg-dark" value="<?=$val?>"<?=$req?> placeholder="<?=$placeholder?>"><?php
    endif;
 } ?>
    ...
    <div class="col-10">
        ...
        <div class="card text-bg-dark text-light m-2">
            ...
            <div class="card-body">
                ...
                <form  id="addVolunteerForm" enctype="multipart/form-data" method="post" action="<?=base_url('/dashboard/volunteer/edit?id='.$user_id)?>" class="text-left mx-2 form-holder">
                    ...
                    <div class="row my-2">
                        <div class="col-3 px-2">
                            ...
                            <?php create_input('first_name', 'Enter Your First Name', $volunteer, 'text', true); ?>
                        ...
                        <div class="col-3 px-2">
                            ...
                            <?php create_input('last_name', 'Enter Your Last Name', $volunteer, 'text', true); ?>
                        ...
                        <div class="col-3 px-2">
                            ...
                            <?php create_input('username', 'Enter Your Username', $volunteer, 'text', true); ?>
                        ...
                        <div class="col-3 px-2">
                            ...
                            <?php create_input('email', 'Enter Your Email', $volunteer, 'email', true); ?>
                    ...
                    <div class="row my-2">
                        <div class="col-6 px-2">
                            ...
                            <?php create_input('password', 'Enter To Change Password', $volunteer, 'password', false); ?>
                        ...
                        <div class="col-6 px-2">
                            ...
                            <?php create_input('pass_confirm', 'Re-enter Your New Password', $volunteer, 'password', false); ?>
                    ...
                    <div class="row my-2">
                        <div class="col-3 px-2">
                            ...
                            <?php create_input('address', 'Enter Your Address', $volunteer); ?>
                        ...
                        <div class="col-2 px-2">
                            ...
                            <?php create_input('home', 'Enter Your Home Phone (Numbers Only)', $volunteer); ?>
                        ...
                        <div class="col-2 px-2">
                            ...
                            <?php create_input('work', 'Enter Your Work Phone (Numbers Only)', $volunteer); ?>
                        ...
                        <div class="col-2 px-2">
                            ...
                            <?php create_input('cell', 'Enter Your Cell Phone (Numbers Only)', $volunteer); ?>
                        ...
                        <div class="col-3 px-2">
                            ...
                            <?php create_input('centers', '', $volunteer, 'hidden'); ?>
                        </div>
                    </div>
                    <!-- Skills/Availability -->
                    <div class="row my-2">
                        <div class="col-6 px-2">
                            ...
                            <?php create_textarea('skills', 'Enter Your Skills/Interests', $volunteer); ?>
                        ...
                        <div class="col-6 px-2">
                            ...
                            <?php create_textarea('available', 'Enter Your Available Times', $volunteer); ?>
                    ...
                    <div class="row my-2">
                        <div class="col-6 px-2">
                            ...
                            <?php create_textarea('licenses', 'Enter Your Current License(s) Information', $volunteer); ?>
                            ...
                            <div class="row my-2">
                                <div class="col-6 px-2">
                                    <?php $label = (strlen($volunteer['drivers']) > 3) ? ": {$link($volunteer['drivers'],'Current Upload')}":" (PNG, JPG, GIF, Or PDF):"?>
                                    <label for="drivers" class="form-label">Upload Drivers License<?=$label?></label>
                                    <?php create_input('drivers', '', $volunteer, 'file'); ?>
                                    <div class="invalid-feedback" id="drivers_validation">
                                        Only File Types Allowed: .png .jpg .jpeg .gif .pdf
                                    </div>
                                </div>
                                <div class="col-6 px-2">
                                    <?php $label = (strlen($volunteer['social']) > 3) ? ": {$link($volunteer['social'],'Current Upload')}":" (PNG, JPG, GIF, Or PDF):"?>
                                    <label for="social" class="form-label">Upload Social Security Card<?=$label?></label>
                                    <?php create_input('social', '', $volunteer, 'file'); ?>
                        ...
                        <div class="col-6 px-2">
                            ...
                            <?php create_textarea('background', 'Enter Your Educational Background', $volunteer, 6); ?>
                    ...
                    <div class="row my-2">
                        <div class="col-3 px-2">
                            ...
                            <?php create_input('e_name', 'Enter Your Emergency Contact Name', $volunteer); ?>
                        ...
                        <div class="col-3 px-2">
                            ...
                            <?php create_input('e_phone', 'Enter Your Emergency Contact Phone', $volunteer); ?>
                        ...
                        <div class="col-3 px-2">
                            ...
                            <?php create_input('e_email', 'Enter Your Emergency Contact Email', $volunteer); ?>
                        ...
                        <div class="col-3 px-2">
                            ...
                            <?php create_input('e_address', 'Enter Your Emergency Contact Address', $volunteer); ?>
...
<?php if ($getPost) : ?>
    <script>$(document).ready(() => { PSA.Volunteer.init.edit(<?=json_encode($postData)?>); })</script>
<?php else: ?>
    <script>$(document).ready(() => { PSA.Volunteer.init.edit(false); })</script>
<?php endif; ?>
